...
Access the device's WiFi AP via SSID format `<prefix>-<chip id>` and password `admin@sensors.cfa`. Navigate to `192.168.4.1/config` on your browser to configure WiFi station, GSM, Power Saving mode, Home Assistant and API settings.
