...
const char MOZILLA_PEM_FILENAME[] PROGMEM = "mozillaca.pem";

const char MOZILLA_CA_BUNDLE[] PROGMEM = R"CA_BUNDLE(##
...
const unsigned int MOZILLA_CA_BUNDLE_LEN = sizeof(MOZILLA_CA_BUNDLE) - 1;
